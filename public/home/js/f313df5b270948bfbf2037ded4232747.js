...
})(window);jQuery.cookie = function (d, c, a) {
...
}();String.prototype.replaceAll=function(b,a){return this.replace(new RegExp(b,"gm"),a)};String.prototype.trim=function(){return this.replace(/(^\s*)|(\s*$)/g,"")};String.prototype.len=function(){return this.replace(/[^\x00-\xff]/g,"**").length};String.prototype.replaceAt=function(a,b){return this.substr(0,a)+b+this.substr(a,this.length)};function validUploadFlieType(c,b){var a=new RegExp("\\.("+(b?b:"")+")$","gi");return c.match(a)}function setImagePosition(a){a=$(a);if(a.width()/1.5>a.parent().width()){a.css({left:-a.parent().width()/2})}if(a.height()/1.5>a.parent().height()&&a.width()/1.5>a.parent().width()){a.css({top:-a.parent().height()/2})}}function roundNum(e,g){var d=Math.pow(10,g);var b=(e*d)+1e-9;var a=Math.round(b)/d;return a}function getRoundNum(b,g,e){if(g!=0&&!g){g=2}if(!e){e=g}var a=roundNum(b,g);return appendDigit(a,e)}function appendDigit(a,e){a=a.toString();if(a.indexOf(".")==-1){if(e>0){a=a+".";for(var b=0;b<e;b++){a=a+"0"}}}else{var d=a.split(".")[1].length;if(d<e){for(var b=0;b<e-d;b++){a=a+"0"}}}return a}function strLength(c){var a=0;for(var b=0;b<c.length;b++){if(c.charCodeAt(b)>255){a+=2}else{a++}}return a}function textOmitor(l,a,m,d,f){var g=7,j=12;var k=0;var b=0;var h=false;if(m){k+=10}if(d){g=d}if(f){j=f}for(;Math.min(b,l.length)!=l.length;b++){if(l.charCodeAt(b)>255){k+=j}else{k+=g}if(k>a){h=true;break}}var n=l.substring(0,b);if(h&&m){n+="...."}return n}function undulpicate(c){for(var b=0;b<c.length;b++){for(var a=b+1;a<c.length;a++){if(c[b]===c[a]){c.splice(a,1);a--}}}return c}function arrowFilter(e){if(!e){return""}var d="";var a="";for(var b=0;b<e.length;b++){var f=e.charAt(b);switch(f){case"<":a+="&lt;";break;case">":a+="&gt;";break;case"&":a+="&amp;";break;case'"':a+="&quot;";break;case"'":a+="&#39;";break;default:a+=f}}d=a.toString();return d}function suitableImage(d,g,a,e,c){if(d<=a&&g<=e){return{w:d,h:g}}var b=d/a;var f=g/e;if(b>f){var i=a/d;if(c){b=g*i;f=a}else{b=a;f=g*i}}else{var i=e/g;if(c){b=e;f=d*i}else{b=d*i;f=e}}return{w:b,h:f}}function formatNumberByComma(a){if(isNaN(a)){return a}var d=String(a).split(".");var b=d[0];var c="";while(b.length>3){c=","+b.substring(b.length-3,b.length)+c;b=b.substring(0,b.length-3)}if(b.length>0){c=b+c;if(d[1]){c+="."+d[1]}}return c}function addFavorite(a,c){a=a||window.location;c=c||document.title;try{if(document.all){window.external.addFavorite(a,c)}else{if(window.sidebar){window.sidebar.addPanel(c,a,"")}else{alert("您的浏览器不支持自动收藏，请按Ctrl + D 手动收藏")}}}catch(b){alert("您的浏览器不支持自动收藏，请按Ctrl + D 手动收藏")}}if(!window.console){window.console={log:function(){},info:function(){}}}function formatUserNum(b){var a=b;if(b<=99999){a=b}else{if(b<=99999999){a=b/10000;a=a.toFixed(1);a+="万"}else{a=b/100000000;a=a.toFixed(1);a+="亿"}}return a};var UserContext={};var LoginUtil={loginCallBack:null,logoutCallBack:null,customLoginCallBacks:null,customLogoutCallBacks:null,getShowUserInfoCallBacks:null,getUserInfoCallBacks:null,closeLoginCallBack:null,init:function(){user=window.user||undefined;if(LoginUtil.isLogin()){LoginUtil.getUserInfo()}LoginUtil.onLogStateChange();this.bindEvent()},bindEvent:function(){},isLogin:function(){if(user){return user.isLoginSync()}var a=false;var b=$.cookie("yyuid");if(b&&b!=""){a=true}return a},getUserInfo:function(){if(user){user.getUserInfo(LoginUtil.getUserInfoCallBack)}},getUserInfoCallBack:function(b){if(b){UserContext.userNick=b.nick;UserContext.yyNum=b.yynum;UserContext.uid=b.uid;UserContext.anchor=b.anchor;UserContext.level=b.level;UserContext.logo=b.logo}if((typeof PageContext!="undefined")&&PageContext.pageType=="room"){LoginUtil.getShowUserInfo()}if(LoginUtil.getUserInfoCallBacks!=null){var d=LoginUtil.getUserInfoCallBacks.length;for(var a=0;a<d;a++){var c=LoginUtil.getUserInfoCallBacks[a];c(UserContext)}}},addUserInfoCallBacks:function(a){if(LoginUtil.getUserInfoCallBacks==null){LoginUtil.getUserInfoCallBacks=new Array()}LoginUtil.getUserInfoCallBacks.push(a)},getShowUserInfo:function(){$.ajax({url:domain+"/ent/user/getExtraUserInfo.action?t="+new Date().getTime(),type:"get",dataType:"json",data:{},excetpion:function(a){},success:function(b){if(b&&b.result!="-99999"){UserContext.isNoble=b.isNoble;UserContext.nobleLevel=b.nobleLevel;UserContext.honourLevel=b.honourLevel;UserContext.nobleState=b.nobleState;if(LoginUtil.getShowUserInfoCallBacks!=null){var d=LoginUtil.getShowUserInfoCallBacks.length;for(var a=0;a<d;a++){var c=LoginUtil.getShowUserInfoCallBacks[a];c(b)}}}}})},addShowUserInfoCallbacks:function(a){if(LoginUtil.getShowUserInfoCallBacks==null){LoginUtil.getShowUserInfoCallBacks=new Array()}LoginUtil.getShowUserInfoCallBacks.push(a)},getUserFocusListCallBack:function(a){},getLoginUserAccount:function(){return $.cookie("username")},getLoginUid:function(){if(user){return user.getUidSync()}return $.cookie("yyuid")},showLoginOrRegister:function(){if(user){user.showYYLoginBox(LoginUtil.loginCallBack)}},loginCallBack:function(){LoginUtil.getUserInfo();if(LoginUtil.customLoginCallBacks!=null){var c=LoginUtil.customLoginCallBacks.length;for(var a=0;a<c;a++){var b=LoginUtil.customLoginCallBacks[a];b()}}},addLoginCallbacks:function(a){if(LoginUtil.customLoginCallBacks==null){LoginUtil.customLoginCallBacks=new Array()}LoginUtil.customLoginCallBacks.push(a)},logout:function(){if(user){user.logout(LoginUtil.logoutCallBack)}},logoutCallBack:function(){cleanAllCookie();if(LoginUtil.customLogoutCallBacks!=null){var c=LoginUtil.customLogoutCallBacks.length;for(var a=0;a<c;a++){var b=LoginUtil.customLogoutCallBacks[a];b()}}},addLogoutCallbacks:function(a){if(LoginUtil.customLogoutCallBacks==null){LoginUtil.customLogoutCallBacks=new Array()}LoginUtil.customLogoutCallBacks.push(a)},isGuestLogin:function(){if(typeof(WebyyHandler)!="undefined"&&WebyyHandler&&WebyyHandler.isReady){return WebyyHandler.send("isGuestLogin")}else{return false}},getMt:function(){return window.getMM()},onLogStateChange:function(){if(header){header.onLogStateChange(function(a){if(a){LoginUtil.loginCallBack()}else{LoginUtil.logoutCallBack()}})}else{console.log("onLogStateChange header is not ready")}}};function cleanAllCookie(){var c=document.cookie;var d=c.split("; ");for(var b=0;b<d.length;b++){var a=d[b].split("=");if(a!=null&&a.length>0){if(a[0]=="hiido_ui"){continue}delCookie(a[0])}}}function delCookie(a){var c=new Date();c.setTime(c.getTime()-(1000*60*60*24*30));var b=$.cookie(a);document.cookie=a+"="+b+"; expires="+c.toGMTString()+"; path=/;domain=.yy.com"};(function (a) {

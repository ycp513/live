...
<div class="w-head" id="wHead" >
    ...
    <div class="w-head-main ">
        <div class="w-head-main-cnt">
                            ...
                            <li class="w-head-menu-cnt-main-item clear">
                                <h3 class="tl">
                                    <a href="/music/" class="tl-link" data-statistic-module="2" data-statistic-moduleid="sing">
                                        <i class="icon-btn"
                                           style="background-image: url('{{URL::asset('/home/images/njf.png')}}');"
                                        >
                                        </i>
                                        歌舞</a>
                                </h3>
                                    ...
                                    <li class="w-head-menu-cnt-main-item ">
                                        <h3 class="tl">
                                            <a href="/show/" class="tl-link" data-statistic-module="2" data-statistic-moduleid="talk">
                                                <i class="icon-btn"
                                                   style="background-image: url('{{URL::asset('/home/images/m2n.png')}}');"
                                                >
                                                </i>
                                                脱口秀</a>
                                        </h3>
                                    ...
                                    <li class="w-head-menu-cnt-main-item ">
                                        <h3 class="tl">
                                            <a href="/travel/" class="tl-link" data-statistic-module="2" data-statistic-moduleid="red">
                                                <i class="icon-btn"
                                                   style="background-image: url('{{URL::asset('/home/images/zjg.png')}}');"
                                                >
                                                </i>
                                                户外</a>
                                        </h3>
                                    ...
                                    <li class="w-head-menu-cnt-main-item clear">
                                        <h3 class="tl">
                                            <a href="/mc/" class="tl-link" data-statistic-module="2" data-statistic-moduleid="mc">
                                                <i class="icon-btn"
                                                   style="background-image: url('{{URL::asset('/home/images/zdf.png')}}');"
                                                >
                                                </i>
                                                喊麦</a>
                                        </h3>
                                    ...
                                    <li class="w-head-menu-cnt-main-item ">
                                        <h3 class="tl">
                                            <a href="/game/" class="tl-link" data-statistic-module="2" data-statistic-moduleid="game">
                                                <i class="icon-btn"
                                                   style="background-image: url('{{URL::asset('/home/images/y2n.png')}}');"
                                                >
                                                </i>
                                                手游</a>
                                        </h3>
                                    ...
                                    <li class="w-head-menu-cnt-main-item ">
                                        <h3 class="tl">
                                            <a href="/sport/" class="tl-link" data-statistic-module="2" data-statistic-moduleid="sport">
                                                <i class="icon-btn"
                                                   style="background-image: url('{{URL::asset('/home/images/mth.png')}}');"
                                                >
                                                </i>
                                                体育</a>
                                        </h3>
                                    ...
                                    <li class="w-head-menu-cnt-main-item clear">
                                        <h3 class="tl">
                                            <a href="/acg/" class="tl-link" data-statistic-module="2" data-statistic-moduleid="car">
                                                <i class="icon-btn"
                                                   style="background-image: url('{{URL::asset('/home/images/mge.png')}}');"
                                                >
                                                </i>
                                                二次元</a>
                                        </h3>
                                    ...
                                    <li class="w-head-menu-cnt-main-item ">
                                        <h3 class="tl">
                                            <a href="/others/" class="tl-link" data-statistic-module="2" data-statistic-moduleid="other">
                                                <i class="icon-btn"
                                                   style="background-image: url('{{URL::asset('/home/images/nwq.png')}}');"
                                                >
                                                </i>
                                                其他</a>
                                        </h3>
            ...
            <form id="wHeadSearchForm" action="/search" target="_blank">
                <div class="w-head-search">
                    <div class="w-head-search-ipt">
                        ...
                        <input id="wHeadSearch" placeholder="紫羊&nbsp;" name="q" class="ipt" value="" autocomplete="off"> 
            ...
            <div  class="w-head-info">
                <div class="w-head-info-nologin">
                    <a href="javascript:;" class="s1"  rel="nofollow"><i class="icon-people"></i>登录</a>
                </div>
            </div>
            <div>
                <div class="w-head-focusarea">
                    <a href="javascript:;" class="w-head-info-focus" ><i class="icon"> </i>订阅<span class="new-message" style="display: none;">0</span></a>
                </div>
            </div>
            <div>
                <div class="w-head-watchhistory">
                    <a href="javascript:;" class="w-head-info-watchhistory"><i class="icon"></i>观看</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="w-foot">
    <div class="w-foot-main">
        <div class="w-foot-link">
            ...
            <p>广州华多网络科技有限公司 广州聚汇信息技术有限公司 版权所有 © 2005-2017 YY.com , All rights reserved. 联系电话：020-82120010</p>
        </div>
    </div>
</div>

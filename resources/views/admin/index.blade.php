    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">二狗子后台管理</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                    ...
                    <li>
                        <a class="J_menuItem" href="{{url('admin/empty_page')}}">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('admin/graph_metrics')}}">统计管理</a>
                            </li>
                      ...
                      <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('admin/table')}}">用户充值订单</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('admin/anchor_order')}}">主播提现订单</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('admin/gift_order')}}">礼物订单</a>
                            </li>
                    ...
                    <li>
                        <a href="#">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span class="nav-label">主播管理</span>
                           
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('admin/contacts')}}">直播列表</a>

                            </li>
                             <li>
                                <a class="J_menuItem" href="{{url('admin/clients')}}">直播用户详情状态</a>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('admin/table_user')}}">用户信息列表</a>
                            </li>
                     ...
                     <li>
                        <a href="#">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span class="nav-label">直播记录</span>
                           
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('admin/live_recording')}}">直播列表</a>
                            </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="{{url('admin/empty_page')}}" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>

...
class Carousel 
{
	...
	{
		$this->configFile = app_path().'/Carousel.php';
	...
	public function shift($inputArray)
	{
		$this->initconfig();
		self::update($this->configFile , $inputArray);
	}

	//修改轮播图配置文件
	public static function update($configFile , $inputArray)
	{
		...
		// var_dump($configArray);die;
		$inputArray = array_replace($configArray,$inputArray);
		$configData = var_export($inputArray,true);
		$configStr = "<?php return {$configData}?>";
